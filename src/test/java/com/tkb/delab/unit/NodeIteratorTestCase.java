...
import com.tkb.delab.alg.NodeIterator;
...
/**
 * A node iterator triangulation test case on graphs of various types.
 *
 * @author Akis Papadopoulos
 */
public class NodeIteratorTestCase extends TriangulationTestCase {

    private final Triangulator triangulator = new NodeIterator();
